     ...
     D  errorCode                 32767A         options(*nopass)
     ...
     D  usErrorCode               32767A         options(*varsize)
      *
     ...
     D  userspace                    20A   const
     D  pointer                        *
     D  errorCode                 32767A   const options(*varsize: *nopass)
      *
     ...
     D  errorCode                 32767A         options(*varsize)
      ...
      /include qsysinc,QBNLPGMI
      /include qsysinc,QBNLSPGM
      /include qsysinc,QCLRPGMI
      ...
      /include qsysinc,QMHRCVPM
      /include qsysinc,QMHSNDPM
      ...
      /include qsysinc,QUSRMBRD
      /include qsysinc,QUSROBJD
      /include qsysinc,QWDRJOBD
      /include qsysinc,QWVRCSTK
